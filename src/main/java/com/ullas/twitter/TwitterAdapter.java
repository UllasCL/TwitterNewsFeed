...
public class TwitterAdapter extends ArrayAdapter<String>
{
    ...
    {
        super(context, R.layout.activity_twitter_adapter, al_newslist);
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.activity_twitter_adapter, parent, false);
